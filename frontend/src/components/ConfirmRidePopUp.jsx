      ...
      <div className='mt-6 w-full'>
        <form onSubmit={(e)=>{
          submitHandler(e)
            ...
            <Link 
              to='/captain-riding'
              className='mt-5 flex justify-center w-full bg-green-600 text-white font-semibold p-2 rounded-lg'>
              Confirm
            </Link>

            <button onClick={()=>{
              props.setconfirmRidePopUpPannel(false)
            }} className='mt-1 w-full bg-red-400 text-white font-semibold p-2 rounded-lg'>
              Cancel
            </button>
        </form>
      </div>
